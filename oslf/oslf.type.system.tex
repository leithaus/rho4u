...
hom-functor of $\mathsf{NT}$. That is, $\meaningof{P_{1}} : \meaningof{\Gamma_{1}} \to \meaningof{\mathbf{U}_{1} : \mathbf{X}_{1}} = \mathsf{NT}(-_{1},-_{2})$. Thus, the meaning of an inference rule is a (di-)natural transformation from $\mathsf{NT}(-_{1}, -_{2}) \times \cdots \times \mathsf{NT}(-_{1}, -_{2}) \Rightarrow k \circ \mathsf{NT}(-_{1}, -_{2}) \times \cdots \times \mathsf{NT}(-_{1}, -_{2})$ where $k$ is the constructor of the consequent of the rule.
