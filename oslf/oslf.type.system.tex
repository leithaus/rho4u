...
\begin{mathpar}
  ...
  \and
  \inferrule* [lab=Separation] {}{\Gamma \vdash P : \mathbf{U} : \mathbf {X} \Vdash \Gamma \vdash \mathsf{in}_{L} P : ((\mathbf{U} \Rightarrow \bot_{X}) + \mathbf{\top}_{Y}) \Rightarrow \bot_{X+Y} : \mathbf {X+Y}} \\
  \and
