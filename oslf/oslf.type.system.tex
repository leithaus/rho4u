...
\begin{mathpar}
  ...
  \and
  \inferrule* [lab=Labelled-Step-Future] {\Gamma \vdash R : \mathbf{E} : \mathbf {R} \and \Gamma \vdash R \equiv P \odot Q \and \Gamma \vdash P : \mathbf{U} : \mathbf {P} \and \Gamma \vdash Q : \mathbf{V} : \mathbf{P}}{\Gamma \vdash \mathsf{src}(R) : \langle \mathbf{V} \rangle_{\mathsf{r}} \mathsf{trgt}(\mathbf{E}) : \mathbf {P}}
  \and
  \inferrule* [lab=Labelled-Step-Future] {\Gamma \vdash R : \mathbf{E} : \mathbf {R} \and \Gamma \vdash R \equiv P \odot Q \and \Gamma \vdash P : \mathbf{U} : \mathbf {P} \and \Gamma \vdash Q : \mathbf{V} : \mathbf{P}}{\Gamma \vdash \mathsf{src}(R) : \langle \mathbf{U} \rangle_{\mathsf{l}} \mathsf{trgt}(\mathbf{E}) : \mathbf {P}}
  \and
  ...
  \and
  \inferrule* [lab=Labelled-Step-Past] {\Gamma \vdash R : \mathbf{E} : \mathbf {R} \and \Gamma \vdash R \equiv P \odot Q \and \Gamma \vdash P : \mathbf{U} : \mathbf {P} \and \Gamma \vdash Q : \mathbf{V} : \mathbf{P}}{\Gamma \vdash \mathsf{trgt}(R) : \llangle \mathbf{U} \rrangle_{\mathsf{r}} \mathsf{src}(\mathbf{E}) : \mathbf {P}}
  \and
  \inferrule* [lab=Labelled-Step-Past] {\Gamma \vdash R : \mathbf{E} : \mathbf {R} \and \Gamma \vdash R \equiv P \odot Q \and \Gamma \vdash P : \mathbf{U} : \mathbf {P} \and \Gamma \vdash Q : \mathbf{V} : \mathbf{P}}{\Gamma \vdash \mathsf{trgt}(R) : \llangle \mathbf{V} \rrangle_{\mathsf{l}} \mathsf{src}(\mathbf{E}) : \mathbf {P}}
\end{mathpar}
