...
\begin{mathpar}
  ...
  \and
  \inferrule* [lab=Character] {} {\Gamma \vdash Q : \mathbf{U} : \mathbf {X} \Vdash \Gamma \vdash \chi_Q : \mathbf{\{ Q \}} : \mathbf {X}}
  \and
...
$$\begin{array}{l}
  \meaningof{\Gamma \vdash Q : \mathbf{U} : \mathbf {X} \Vdash \Gamma \vdash \chi_Q : \mathbf{\{ Q \}} : \mathbf {X}} \\
  = \\
  \meaningof{\mathsf{Character}} : \meaningof{Q} : \meaningof{\Gamma} \to \meaningof{\mathbf{U} : \mathbf{X}} \Rightarrow \meaningof{\chi_Q} : \meaningof{\Gamma} \to \meaningof{\mathbf{\{ Q \}} : \mathbf {X}} \\
	\meaningof{Q}(S):\mathsf{NT}(\meaningof{\Gamma}(S), \meaningof{\mathbf{U} : \mathbf{X}}(S)) \mapsto \meaningof{\chi_Q}(S): \mathsf{NT}(\meaningof{\Gamma}(S), {\rm Im}(\meaningof{Q}(S))) = \meaningof{Q}(S)|_{{\rm Im}(Q)(S)}
\end{array}$$
