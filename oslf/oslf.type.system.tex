...
\begin{mathpar}
  ...
  \and
  \inferrule* [lab=ApplyR-Src] {\Gamma \vdash \mathsf{apply}_{R}(P_{1}, p \Rightarrow P_{2}) : \mathbf{match}_{R}(\mathbf{U},\mathbf{U} \twoheadrightarrow \mathbf{V}) : \mathbf {S}}{\Gamma \vdash \mathsf{src}(\mathsf{apply}_{R}(P_{1},P_{2})) = P_{1} \; \odot \; p \Rightarrow P_{2} : \mathbf{U} \; \odot \; \mathbf{U} \twoheadrightarrow \mathbf{V} : \mathbf {P}} \\
  \and
