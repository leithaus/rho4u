...
\begin{mathpar}
  \inferrule* [lab=Comm] {\Gamma_{1} \vdash x : \mathbf{U} : \mathbf{N} \;\;\; y : \mathbf{\quotep{V}} : \mathbf{N}, \Gamma_{2} \vdash P : \mathbf{W} : \mathbf{P} \;\;\; \Gamma_{3} \vdash Q : \mathbf{V} : \mathbf{P}}{\Gamma_{1}, \Gamma_{2}, \Gamma_{3} \vdash \commr{x}{y}{P}{Q} : \commt{U}{V}{W} : \mathbf{R}} \\
  \and  
