...
\begin{mathpar}
  ...
  \and
  \inferrule* [lab=Operator]{\Theta \rhd \arrvec{x}_{1} : \arrvec{t}_{1},\ldots,\arrvec{x}_{n} : \arrvec{t}_{n}, \Gamma \vdash t_{i} : \tau_{i} \;\;\; o : (\arrvec{\sigma_{1}})\tau_{1} \times \ldots \times (\arrvec{\sigma_{n}})\tau_{n} \to \tau}{\Theta \rhd \Gamma \vdash o(\arrvec{x}_{1},\ldots,\arrvec{x}_{n}) : \tau} 
\end{mathpar}
