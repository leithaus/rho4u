...
\newcommand{\commr}[4]{\mathsf{for(}#2 \leftarrow #1 \mathsf{)} #3 \mathsf{|} #1\mathsf{!}(#4)}
\newcommand{\commt}[3]{\mathbf{for(}\mathbf{#2} \leftarrow \mathbf{#1} \mathbf{)} \mathbf{#3} \mathbf{|} \mathbf{#1}\mathbf{!}(\mathbf{#2})}
