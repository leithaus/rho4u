...
\newcommand{\MC}{MeTTaCycle}
\newcommand{\FD}{F1R3Dr1v3}
\newcommand{\FF}{F1R3FLY.io}
...
limitation. \MC scales to match the throughput characteristics
...
accounting). In \MC these two have been seamlessly integrated
