...
$\mathsf{MeTTaIL}$ is
$\href{https://github.com/F1R3FLY-io/MeTTa/blob/dev/GSLT/src/main/bnfc/metta_venus.cf}{linked here}$. An example of a specification for $\mathsf{rholang}$ is $\href{https://gist.github.com/leithaus/9cef95f3b703a406385e94cb6b1aab67}{linked here}$.

The $\mathsf{rholang}$ example is of particular note in the
decentralization space. It is a smart contracting language. We fully
anticipate being able to provide $\mathsf{MeTTaIL}$ specs for other
smart contracting languages including $\mathsf{Solidity}$, as well as
$\mathsf{Solana}$ and $\mathsf{Cardano}$'s smart contracting
languages. In this way we aim to allow $\MC$ nodes to be fully
compliant nodes in other chains. However, this nodes will also allow
data on chain and agentic computation.
