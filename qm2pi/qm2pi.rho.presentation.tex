...
We can think of $\odot$ as a form of \emph{evaluation} for the confluent, terminating fragment of $\Proc$\footnote{Indeed, confluent and terminating computations are probably the best candidate, as any, for the notion of \emph{data}.}.
