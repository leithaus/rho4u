...
then the probability of $S$ reducing via any interaction is $R = \Sigma r_{i}M_{i}M_{i+1}$. And the probability of interacting via $x_{i}$ is $r_{i}M_{i}M_{i+1}/R$. We can apply Gillespie's algorithm to simulate how $S$ evolves.
