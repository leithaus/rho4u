...
Here we describe a variant of the $\mathsf{Linda}$ tuple space where
input is not blocking. Instead, we turn input from a key into the
storage of a continuation at the key. 

\includegraphics[scale=0.5]{RHO20RSpaceSlide1.pdf}
