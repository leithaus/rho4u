...
\begin{mathpar}
  \inferrule* [lab=Query]{k = \mathsf{\{} (\mathsf{=}\; t_{1} \; u_{1}), \ldots, (\mathsf{=}\; t_{n} \; u_{n}) \mathsf{\}} \pplus k', \and \mathsf{insensitive}(t',k') \\ \sigma_{i} = \mathsf{unify}(t',t_{i}), \and w' = \mathsf{\{} (u_{1}\sigma_{1})_{\chi(p,\bot)} \mathsf{\}} \pplus\; \ldots\; \pplus \mathsf{\{} (u_{n}\sigma_{n})_{\chi(p,\bot)} \mathsf{\}} \pplus w \\ c = \Sigma_{i}\mathsf{\#}(\sigma_{i}) + \Sigma_{i}\mathsf{\#}(u_{i}\sigma_{i}), \and ((e' + e ) - c) > 0 \\ eos = \{(h(p)\; e')\} \pplus eos', \and eos'' = \{(h(p)\; ((e' + e ) - c))\} \pplus eos' }{\langle \mathsf{\{} t'_{\chi(p,e)} \mathsf{\}} \pplus i, k, w, o; eos \rangle \xrightarrow{c} \langle i, k, w', o; eos'' \rangle} \\
  \and
  \inferrule* [lab=Chain]{k = \mathsf{\{} (\mathsf{=}\; t_{1} \; u_{1}), \ldots, (\mathsf{=}\; t_{n} \; u_{n}) \mathsf{\}} \pplus k',\and \mathsf{insensitive}(u,k') \\ \sigma_{i} = \mathsf{unify}(u,t_{i}), \and w' = \mathsf{\{} (u_{1}\sigma_{1})_{\chi(p,\bot)} \mathsf{\}} \pplus\; \ldots\; \pplus \mathsf{\{} (u_{n}\sigma_{n})_{\chi(p,\bot)} \mathsf{\}} \pplus w \\ c = \Sigma_{i}\mathsf{\#}(\sigma_{i}) + \Sigma_{i}\mathsf{\#}(u_{i}\sigma_{i}), \and (e - c) > 0 \\ eos = \{(h(p)\; e)\} \pplus eos', \and eos'' = \{(h(p)\; (e - c))\} \pplus eos'}{\langle i, k, \mathsf{\{} u_{\chi(p,\bot)} \mathsf{\}} \pplus w, o; eos \rangle \xrightarrow{c} \langle i, k,  w', o; eos'' \rangle} \\
  \and
  \inferrule* [lab=Transform]{k = \mathsf{\{} t_{1}, \ldots, t_{n} \mathsf{\}} \pplus k',\and \mathsf{insensitive}(t,k')\\ \sigma_{i} = \mathsf{unify}(t,t_{i}), \and w' = \mathsf{\{} (u\sigma_{1})_{\chi(p,\bot)} \mathsf{\}} \pplus\; \ldots\; \pplus \mathsf{\{} (u\sigma_{n})_{\chi(p,\bot)} \mathsf{\}} \pplus w \\ c = \Sigma_{i}\mathsf{\#}(\sigma_{i}) + \Sigma_{i}\mathsf{\#}(u\sigma_{i}), \and (e - c) > 0 \\ eos = \{(h(p)\; e)\} \pplus eos', \and eos'' = \{(h(p)\; (e - c)) \} \pplus eos'}{\langle \mathsf{\{} \mathsf{(}\mathsf{transform}\; t \; u\mathsf{)} \mathsf{\}} \pplus i, k, w, o; eos \rangle \xrightarrow{c} \langle i, k, w', o; eos'' \rangle} \\
  \and
  \inferrule* [lab=AddAtom1]{(e - \mathsf{\#}(t)) > 0 \\ eos = \{(h(p)\; e)\} \pplus eos', \and eos'' = \{(h(p)\; (e - \mathsf{\#}(t))) \} \pplus eos'}{\langle \mathsf{\{} \mathsf{(} \mathsf{addAtom}\; t\mathsf{)}\mathsf{\}}  \pplus i, k, o; eos \rangle \xrightarrow{\mathsf{\#}(t)} \langle i, k \pplus \mathsf{\{} t\mathsf{\}}, w, \mathsf{\{} \mathsf{()}\mathsf{\}} \pplus o; eos'' \rangle} \\
  \and
  \inferrule* [lab=AddAtom2]{\langle i_{1}, k_{1}, w_{1}, o_{1}; eos_{1}\rangle \xrightarrow{c} \langle i_{2}, k_{2}, w_{2}, o_{2}; eos_{2} \rangle, k_{3} = \mathsf{\{} \mathsf{(} \mathsf{addAtom}\; t\mathsf{)}\mathsf{\}} \pplus k_{1} \\ (e - \mathsf{\#}(t)) > 0 \\ eos_{1}' = \{(h(p)\; e)\} \pplus eos_{1}, \and eos_{2}' = \{(h(p)\; (e - \mathsf{\#}(t))) \} \pplus eos_{2}}{\langle i_{1}, k_{3}, w_{1}, o_{1}; eos_{1}'\rangle \xrightarrow{\mathsf{\#}(t)} \langle i_{2}, \mathsf{\{} \mathsf{(} \mathsf{addAtom}\; t\mathsf{)}, t\mathsf{\}} \pplus k_{2}, w_{2}, \mathsf{\{} \mathsf{()}\mathsf{\}} \pplus o_{2}; eos_{2}' \rangle} \\
  \inferrule* [lab=RemAtom1]{(e - \mathsf{\#}(t)) > 0 \\ eos = \{(h(p)\; e)\} \pplus eos', \and eos'' = \{(h(p)\; (e - \mathsf{\#}(t))) \} \pplus eos'}{\langle \mathsf{\{} \mathsf{(} \mathsf{remAtom}\; t\mathsf{)}\mathsf{\}}  \pplus i, \mathsf{\{} t \mathsf{\}} \pplus k, w, o; eos \rangle \xrightarrow{\mathsf{\#}(t)} \langle i, k,  \mathsf{\{} w, \mathsf{()}\mathsf{\}} \pplus o; eos'' \rangle} \\
  \and
  \inferrule* [lab=RemAtom2]{\langle i_{1}, k_{1}, w_{1}, o_{1}; eos_{1}\rangle \xrightarrow{c} \langle i_{2}, k_{2}, w_{2}, o_{2}; eos_{2} \rangle, k_{3} = \mathsf{\{} \mathsf{(} \mathsf{remAtom}\; t\mathsf{)} \mathsf{\}} \pplus \mathsf{\{} t \mathsf{\}} \pplus k_{1} \\ (e - \mathsf{\#}(t)) > 0 \\ eos_{1}' = \{(h(p)\; e)\} \pplus eos_{1}, \and eos_{2}' = \{(h(p)\; (e - \mathsf{\#}(t))) \} \pplus eos_{2}}{\langle i_{1}, k_{3}, w_{1}, o_{1}; eos_{1}\rangle \xrightarrow{\mathsf{\#}(t)} \langle i_{2}, \mathsf{\{} \mathsf{(} \mathsf{remAtom}\; t\mathsf{)}\mathsf{\}} \pplus k_{2}, w_{2}, \mathsf{\{} \mathsf{()}\mathsf{\}} \pplus o_{2}; eos_2 \rangle} \\
  \and
...
\begin{mathpar}
  \inferrule* [lab=BoolAdd1]{}{\langle \mathsf{\{} \mathsf{(} \mathsf{+}\; b_{1} \; b_{2} \mathsf{)}\mathsf{\}}  \pplus i, k, o; eos \rangle \xrightarrow{{\#}(b_{1}) + \mathsf{\#}(b_{2})} \langle i, k, \mathsf{\{} b_{1}\mathsf{||} b_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=BoolAdd2]{k = \mathsf{\{} \mathsf{(} \mathsf{+}\; b_{1} \; b_{2} \mathsf{)}\mathsf{\}} \pplus k'}{\langle i, k, o; eos \rangle \xrightarrow{{\#}(b_{1}) + \mathsf{\#}(b_{2})} \langle i, k, \mathsf{\{} b_{1}\mathsf{||} b_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=BoolMult1]{}{\langle \mathsf{\{} \mathsf{(} \mathsf{*}\; b_{1} \; b_{2} \mathsf{)}\mathsf{\}}  \pplus i, k, o; eos \rangle \xrightarrow{{\#}(b_{1}) + \mathsf{\#}(b_{2})} \langle i, k, \mathsf{\{} b_{1}\mathsf{\&} b_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=BoolMult2]{k = \mathsf{\{} \mathsf{(} \mathsf{*}\; b_{1} \; b_{2} \mathsf{)}\mathsf{\}} \pplus k'}{\langle i, k, o; eos \rangle \xrightarrow{{\#}(b_{1}) + \mathsf{\#}(b_{2})} \langle i, k, \mathsf{\{} b_{1}\mathsf{\&} b_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=NumAdd1]{}{\langle \mathsf{\{} \mathsf{(} \mathsf{+}\; n_{1} \; n_{2} \mathsf{)}\mathsf{\}}  \pplus i, k, o; eos \rangle \xrightarrow{{\#}(n_{1}) + \mathsf{\#}(n_{2})} \langle i, k, \mathsf{\{} n_{1}\mathsf{+} n_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=NumAdd2]{k = \mathsf{\{} \mathsf{(} \mathsf{+}\; n_{1} \; n_{2} \mathsf{)}\mathsf{\}} \pplus k'}{\langle i, k, o; eos \rangle \xrightarrow{{\#}(n_{1}) + \mathsf{\#}(n_{2})} \langle i, k, \mathsf{\{} n_{1}\mathsf{+} n_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \inferrule* [lab=NumMult1]{}{\langle \mathsf{\{} \mathsf{(} \mathsf{*}\; n_{1} \; n_{2} \mathsf{)}\mathsf{\}}  \pplus i, k, o; eos \rangle \xrightarrow{{\#}(n_{1}) + \mathsf{\#}(n_{2})} \langle i, k, \mathsf{\{} n_{1}\mathsf{*} n_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=NumMult2]{k = \mathsf{\{} \mathsf{(} \mathsf{*}\; n_{1} \; n_{2} \mathsf{)}\mathsf{\}} \pplus k'}{\langle i, k, o; eos \rangle \xrightarrow{{\#}(n_{1}) + \mathsf{\#}(n_{2})} \langle i, k, \mathsf{\{} n_{1}\mathsf{*} n_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=StrAdd1]{}{\langle \mathsf{\{} \mathsf{(} \mathsf{+}\; s_{1} \; s_{2} \mathsf{)}\mathsf{\}}  \pplus i, k, o; eos \rangle \xrightarrow{{\#}(s_{1}) + \mathsf{\#}(s_{2})} \langle i, k, \mathsf{\{} s_{1}\mathsf{+} s_{2} \mathsf{\}} \pplus o; eos \rangle} \\
  \and
  \inferrule* [lab=StrAdd2]{k = \mathsf{\{} \mathsf{(} \mathsf{+}\; s_{1} \; s_{2} \mathsf{)}\mathsf{\}} \pplus k'}{\langle i, k, o; eos \rangle \xrightarrow{{\#}(s_{1}) + \mathsf{\#}(s_{2})} \langle i, k, \mathsf{\{} s_{1}\mathsf{+} s_{2} \mathsf{\}} \pplus o; eos \rangle}
\end{mathpar}
