...
One important point about the JVM versus the previous three
...
registers. WYSIWYG models make static analysis dramatically simpler. Specifically, an analyzer only has to look at terms in the language.
