...
\begin{mathpar}
  \inferrule* [lab=Query]{\sigma_{i} = \mathsf{unify}(t_{i},t')}{\langle \mathsf{!}t', \ldots \rangle \langle \ldots, (\mathsf{=}\; t_{1} \; u_{1}), \ldots, (\mathsf{=}\; t_{k} \; u_{k}), \ldots \rangle \langle \ldots \rangle \to \langle \ldots \rangle \langle \ldots, (\mathsf{=}\; t_{1} \; u_{1}), \ldots, (\mathsf{=}\; t_{k} \; u_{k}), \ldots \rangle \langle \ldots, u_{i}\sigma_{i} \rangle}
\end{mathpar}
