...
\begin{mathpar}
  \begin{array}{lll}
    ...
    \mathsf{|}\; \meaningof{\langle i, \mathsf{\{} (\mathsf{=}\; t_{1} \; u_{1}), \ldots, (\mathsf{=}\; t_{n} \; u_{n}) \mathsf{\}} \pplus k, w, o \rangle}_{E}(i,k,w,o) & &\\
    ...
    \mathsf{|}\; \meaningof{\langle i, \mathsf{\{} t_{1}, \ldots, t_{n} \mathsf{\}} \pplus k, w, o \rangle}_{E}(i,k,w,o) & &\\
